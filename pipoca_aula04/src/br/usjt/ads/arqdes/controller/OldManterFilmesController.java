...
public class OldManterFilmesController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "atualizar":
			...
			String fTitulo = f2.getTitulo();
			filme.setTitulo(fTitulo);

			String fDescricao = f2.getDescricao();
			filme.setDescricao(fDescricao);

			String fDiretor = f2.getDiretor();
			...
			try {
				String fDataLancamento = f2.getDataLancamento().toString();
			...
			String fPopularidade = Double.toString(f2.getPopularidade());

			filme.setPopularidade(Double.parseDouble(fPopularidade));

			String fPosterPath = f2.getPosterPath();
